/* =============================================================================
 * KOSMO OS — Fuente Bitmap 8x8 (Datos)
 * Archivo : gui/font/font8x8.c
 * Fuente  : Variante del CP437 / VGA ROM font, dominio público.
 *           Cada carácter = 8 bytes (1 byte por fila, MSB = columna izquierda)
 * ============================================================================= */

#include "font8x8.h"

const uint8_t font8x8_data[128][8] = {
    /* 0x00 - NUL */ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    /* 0x01 - SOH */ {0x7E,0x81,0xA5,0x81,0xBD,0x99,0x81,0x7E},
    /* 0x02 - STX */ {0x7E,0xFF,0xDB,0xFF,0xC3,0xE7,0xFF,0x7E},
    /* 0x03 - ETX */ {0x6C,0xFE,0xFE,0xFE,0x7C,0x38,0x10,0x00},
    /* 0x04 - EOT */ {0x10,0x38,0x7C,0xFE,0x7C,0x38,0x10,0x00},
    /* 0x05 - ENQ */ {0x38,0x7C,0x38,0xFE,0xFE,0x10,0x28,0x00},
    /* 0x06 - ACK */ {0x10,0x10,0x7C,0xFE,0xFE,0x7C,0x10,0x38},
    /* 0x07 - BEL */ {0x00,0x00,0x18,0x3C,0x3C,0x18,0x00,0x00},
    /* 0x08 - BS  */ {0xFF,0xFF,0xE7,0xC3,0xC3,0xE7,0xFF,0xFF},
    /* 0x09 - TAB */ {0x00,0x3C,0x66,0x42,0x42,0x66,0x3C,0x00},
    /* 0x0A - LF  */ {0xFF,0xC3,0x99,0xBD,0xBD,0x99,0xC3,0xFF},
    ...
    /* 0x15 */       {0x3E,0x61,0x3C,0x66,0x66,0x3C,0x86,0x7C},
    ...
    /* 0x24 - $  */  {0x18,0x7E,0xC0,0x7C,0x06,0x7E,0x18,0x00},
